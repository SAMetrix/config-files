# Generated by Powerlevel10k configuration wizard on 2026-04-07 at 20:03 SAST.
...
###################################[ uv python version ]#######################################
function prompt_uv_python_version() {
  local ver
  ver=$(uv run python --version 2>/dev/null)
  [[ -n $ver ]] && p10k segment -i '🐍' -t "${ver}"
}

typeset -g POWERLEVEL9K_UV_PYTHON_VERSION_PROMPT_COMMAND=prompt_uv_python_version
